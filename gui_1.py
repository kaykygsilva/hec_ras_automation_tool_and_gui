...
class Aplication():
    ...
    def gui(self, plans=None):
        ...
        lbl_dir = Label(frame_1, text="waiting directory...", font=('Arial', 10), anchor='w', highlightbackground="black", highlightthickness=1)
        ...
        txt_content = Label(frame_1, text='...', highlightcolor='black',justify="left", highlightbackground="black", highlightthickness=1)
        ...
        unsteady_content = Label(frame_1, text='...', highlightcolor='black', justify="left", highlightbackground="black",
                            highlightthickness=1)
        ...
        mapping_value = Entry(frame_run_window, textvariable=mapp_var, highlightcolor='black', justify="left", highlightbackground="black",
                             highlightthickness=1)
        ...
        date_start_content = Entry(frame_run_window, textvariable=date_start_var, highlightcolor='black', justify="left",
                                 highlightbackground="black",
                                 highlightthickness=1)
        ...
        def send_changes():
            if btn_start.instate(["!disabled"]):
                ...
                print(f"{compt_var.get()}, {mapp_var.get()}, {hydrogp_var.get()}, {detailed_var.get()}, {date_start_var.get()}, {date_end_var.get()}")
                lista_chngs = [compt_var.get(),mapp_var.get(),hydrogp_var.get(), detailed_var.get(), date_start_var.get(), date_end_var.get()]
